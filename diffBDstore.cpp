...
void wet::diffBD()
{
     ...
     if(mask[k]==2 || mask[k]==1)
    {
		...
		if(mask[d[10]]==1 && mask[d[d[10]][10]]!=2)
    	{
		...
		if(mask[d[11]]==1 && mask[d[d[11]][11]]!=2)
    	{
		...
		if(mask[d[12]]==1 && mask[d[d[12]][12]]!=2)
    	{
		...
		if(mask[d[13]]==1 && mask[d[d[13]][13]]!=2)
    	{
		...
		if(mask[d[14]]==1 && mask[d[d[14]][14]]!=2)
    	{
		...
		if(mask[d[15]]==1 && mask[d[d[15]][15]]!=2)
    	{
		...
		if(mask[d[16]]==1 && mask[d[d[16]][16]]!=2)
    	{
		...
		if(mask[d[17]]==1 && mask[d[d[17]][17]]!=2)
    	{
