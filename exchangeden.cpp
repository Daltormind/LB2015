...
void wet::exchangeden(void)
{
	...
	MPI_Status statusff1, statusff2, statusffa, statusffb, statusffc, statusffd, statusffi, statusffj, statusffk, statusffl, statusgg1, statusg2, statusgga, statusggb, statusggc, statusggd, statusggi, statusggj, statusggk, statusggl; 

	MPI_Request requestOutff1, requestOutff2, requestInff1, requestInff2, requestOutffa, requestOutffb, requestInffa, requestInffb, requestOutffc, requestOutffd, requestInffc, requestInffd, requestOutffi, requestOutffj, requestInffi, requestInffj, requestOutffk, requestOutffl, requestInffk, requestInffl,requestOutgg1, requestOutg2, requestIngg1, requestIng2, requestOutgga, requestOutggb, requestIngga, requestInggb, requestOutggc, requestOutggd, requestInggc, requestInggd, requestOutggi, requestOutggj, requestInggi, requestInggj, requestOutggk, requestOutggl, requestInggk, requestInggl;
	...
	//Sending left (for sender) g2 (only left part, because g2 moves in -x direction)
	MPI_Isend(&(g2[k1]),k1, MPI_DOUBLE, leftProcess, rank*100+11 , MPI_COMM_WORLD, &requestOutg2);
	...
	//Recieving right (for reciever) g2 (only right part, because g2 moves in -x direction)
	MPI_Irecv(&(g2[k2]), k1, MPI_DOUBLE, rightProcess, rightProcess*100+11, MPI_COMM_WORLD, &requestIng2);
	...
	//Recieving right (for reciever) g2 (only right part, because ggd moves in -x direction)
	...
	MPI_Wait(&requestOutg2, &statusg2);
